...
OFFICIAL_UPSTREAM_REPO = "https://github.com/Crackexy/Crackbot"
BOT_IS_UP_TO_DATE = "Your Crackbot is up-to-date!."
NEW_BOT_UP_DATE_FOUND = (
    "**Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Stealing Updates !!"
)
NEW_UP_DATE_FOUND = (
    "**New update found for** {branch_name}\n"
    "Updating And Restarting Userbot..."
)
...
async def deploy_start(bot, message, refspec, remote):
    ...
    await message.edit("**The Latest Updates Has Been Stolen ♥️\nRestarting, It Will Take 3 Mins!!! To Check If I am Alive Just Do `.alive` or `.help`** 🙃")
