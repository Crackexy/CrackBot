...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("Connecting to CrackBot server and analysing that img ...")
        try:
    ...
    if "image" in contentType:
        with io.BytesIO(output_file_name.content) as remove_bg_image:
            remove_bg_image.name = "@Crackbot.png"
        ...
        await event.edit("ReMove.BG API returned Errors. Please report to @CrackBotUB Support Group\n`{}".format(output_file_name.content.decode("UTF-8")))
